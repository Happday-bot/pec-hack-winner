    ...
    <div className="min-h-screen bg-white font-sans flex flex-col">
      ...
      <main className="flex-1 px-6 md:px-16 py-16">
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div
            ref={addToRefs}
            className="relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition transform overflow-hidden group cursor-pointer"
          >
            <div className="absolute -top-8 -right-8 w-24 h-24 bg-gradient-to-br from-green-400 to-green-600 rounded-full opacity-30 group-hover:opacity-50 animate-pulse"></div>
          ...
          <div
            ...
            className="relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition transform overflow-hidden group cursor-pointer"
          >
            <div className="absolute -top-8 -right-8 w-24 h-24 bg-gradient-to-br from-indigo-400 to-indigo-600 rounded-full opacity-30 group-hover:opacity-50 animate-ping-slow"></div>
            ...
            <p className="text-gray-600 mb-4">
              Get recommendations for colleges offering your chosen course.
            </p>
          ...
          <div
            ...
            className="relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition transform overflow-hidden group cursor-pointer"
          >
            <div className="absolute -top-8 -right-8 w-24 h-24 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-full opacity-30 group-hover:opacity-50 animate-spin-slow"></div>
            ...
            <p className="text-gray-600 mb-4">
              Discover scholarships to support your educational journey.
            </p>
...
//   // Get user name from localStorage or fallback to Chandni
//   const name = localStorage.getItem("name") || "Chandni";

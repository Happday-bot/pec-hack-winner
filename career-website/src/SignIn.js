        ...
        <div className="bg-[#EEF0FF] min-h-screen flex items-center justify-center">
            <div className="bg-[#F5F6FF] p-20 rounded-3xl shadow-2xl w-full max-w-2xl border-2 border-[#C7CBFF]">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    {errors.general && (
                        <div className="mb-6 bg-red-100 text-red-700 px-4 py-3 rounded-xl text-center">
                            {errors.general}
                        </div>
                    )}
                    ...
                    <div className="flex items-center justify-between">
                        <button
                            type="submit"
                            disabled={loading}
                            className="bg-gradient-to-r from-[#444EE7] to-[#6B74FF] text-white font-bold py-4 px-10 rounded-xl shadow-lg hover:scale-105 transition"
                        >
                            {loading ? "Signing In..." : "Sign In"}
                        </button>
